                        ...
                        <div class="cart-items">
                            ...
                            <div class="in-check" >
                                <ul class="unit">
                                    ...
                                    <li><span style="margin-left: -10px">Detail</span></li>
                                    <div class="clearfix"> </div>
                                </ul>
                                <%!
                                    int id;
                                ...
                                <%
                                    ...
                                    ArrayList<Sanpham> arr = sp.getsearch(tensp);
                                ...
                                <ul class="cart-header">
                                    <li class="ring-in"><a href="single.jsp?id=<%=id%>" ><img src=<%=Image%> class="img-responsive" alt="" style="width: 82px; height: 117px"></a></li>
                                    <li><span class="name"><%=Tensp%></span></li>
                                    <li><span class="cost"><%=Gia%></span></li>
                                    <li><span class="name"><%=Mota%></span></li>
                                    <div class="clearfix"> </div>
                                </ul>
